...
public class CalculateBill extends JFrame implements ActionListener{
    ...
    CalculateBill() {
        ...
        JLabel lblmeternumber = new JLabel("CA Number");
        ...
        if (ae.getSource() == next) {
            ...
            try {
                ...
                while(rs.next()) {
                    ...
                    totalbill += Integer.parseInt(rs.getString("maintenance_charge"));
                    totalbill += Integer.parseInt(rs.getString("sgst"));
                    totalbill += Integer.parseInt(rs.getString("cgst"));
