...
public class NewCustomer extends JFrame implements ActionListener{
    ...
    NewCustomer() {
        ...
        JLabel lblmeterno = new JLabel("CA Number");
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (!name.matches("^[a-zA-Z]+( [a-zA-Z]+)*$")) {
            JOptionPane.showMessageDialog(null, "Please Enter a Valid Name (Alphabets and Spaces Only).");
            return; // Don't proceed further if the name is not valid
        }
        ...
        if (!email.toLowerCase().endsWith("@gmail.com")) {
            ...
            return; // Don't proceed further if the email is not valid
        }
        
        if (!phone.matches("^\\d{10}$")) {
            JOptionPane.showMessageDialog(null, "Please Enter a Valid 10-Digit Phone Number.");
            return; // Don't proceed further if the phone number is not valid
        }
